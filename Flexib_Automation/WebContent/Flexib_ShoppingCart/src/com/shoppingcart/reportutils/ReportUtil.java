package com.shoppingcart.reportutils;

import java.io.*;
import java.util.ArrayList;
import java.util.Hashtable;

import com.shoppingcart.utils.TestUtils;
...
public class ReportUtil {
	...
	//public static String path = "D:\\Balu\\Workspace\\OnlineStore\\src\\com\\onlinestore\\screenshots";
	public static String path = System.getProperty("user.dir")+"//src//com//shoppingcart//screenshots";
	...
	public static void startTesting(String filename, String testStartTime, String env, String rel) {
		...
		try {
			...
			out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Build Release</b></td>\n");
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<tr>\n");
			out.write("<td width=10%  align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Test Case#</b></td>\n");
	...
	public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status) {
		...
		try {
			...
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
				...
				out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
				out.write("<tr> ");
				out.write("<td align=center width=10%  align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>TestCase Steps</b></td>");
				...
				out.write("<td align=center width=15% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>Screenshot</b></td>");
				out.write("</tr>");
				if (description != null) {
					for (int i = 0; i < description.size(); i++) {
						...
						if (screenShotPath.get(i) != null)
							out.write("<td align=center width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b><a href=" + screenShotPath.get(i) + " target=_blank>Screenshot</a></b></td>");
						else
			...
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
				...
				System.out.println("href=file:///"+ currentSuiteName + "_TC" + tcid + "_" + testCaseName.replaceAll(" ", "_") + ".html>");
