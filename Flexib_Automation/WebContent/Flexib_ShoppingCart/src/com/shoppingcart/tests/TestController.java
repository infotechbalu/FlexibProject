...
import com.shoppingcart.reportutils.ReportUtil;
...
public class TestController extends Resources {
	public static String Result_File = System.getProperty("user.dir")+"\\src\\com\\shoppingcart\\data\\TestSuite1.xlsx";
	...
	public void initBrowser() throws IOException {
		...
		reports = new ExtentReports(
				System.getProperty("user.dir")+"\\src\\com\\shoppingcart\\Reports\\ShoppingCartDemo.html", false);
	...
	public void TestCaseController() throws NoSuchMethodException, SecurityException, IllegalAccessException,
		...
		ReportUtil.startTesting(System.getProperty("user.dir")+"\\src\\com\\shoppingcart\\Reports\\index.html",
				startTime, "Test", "2.1");
					...
					for (int TS = 2; TS <= SuiteData.getRowCount(TestCaseID); TS++) {
						...
						if (TSStatus.contains("Failed")) {
							...
							ReportUtil.addKeyword(Description, keyword, TSStatus,
									System.getProperty("user.dir")+"\\src\\com\\shoppingcart\\screenshots\\" + filename
											+ ".jpg");
							logger.log(LogStatus.FAIL, Description,
									TSStatus + logger.addScreenCapture(new File(
											System.getProperty("user.dir")+"\\src\\com\\shoppingcart\\screenshots\\"
