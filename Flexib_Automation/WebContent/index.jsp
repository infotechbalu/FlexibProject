      ...
      <div class="main_container">
        ...
        <div class="right_col main" role="main">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <br/><br/>
              <div class="count red"><div class="test"><h1><font color="#079DF9">Automation Framework</font></h1></div></div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile">
                <div class="x_title">
                  <h4><font color="#C080F9"><b>Automation Framework Execution</b></font></h4>
                  <div class="clearfix"></div>
                </div>
                 <div class="x_content">
                  <div class="widget_summary">
                    <form id="Form3" action="hybridFrame.jsp" method="post">
                    	<button class="btn btn-info mt-15" name="submit2" form="Form3" value="button3">Keyword Driven Framework - Run</button>  
                    </form>
                    <form id="Form1" action="hybridFrame.jsp" method="post">
                    	<button class="btn btn-info mt-15" name="submit" form="Form1" value="button1">Hybrid Framework - Run</button>  
                    </form>
                    <form id="Form2" action="hybridFrame.jsp" method="post">
                    	<button class="btn btn-info mt-15" name="submit1" form="Form2" value="button2">Cucumber Framework - Run</button>  
                    </form>
                    <div class="clearfix"></div>
                  </div>
                </div>                
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile fixed_height_220 overflow_hidden">
                <div class="x_title" id="navigate">
                  <h4><font color="#C080F9"><b>Automation Testing Execution Log</b></font></h4>
                  <div class="clearfix"></div>
                </div>
					<div id="progress" style=" background-color: black;"><font color="white"><%@include file='HybridExecution.jsp'%></font> 
					<!--<div id="chart1"></div>-->
              </div>
            </div>
			...
			<!-- <div class="col-md-8 col-sm-8 col-xs-12">
              <div class="x_panel tile fixed_height_220 overflow_hidden">
                <div class="x_title" id="navigate">
                  <h4><font color="#C080F9"><b>Load Test Schedule</b></font></h4>
                  <div class="clearfix"></div>
                </div>
					<img src="images/LoadTestSchedule.png" width="100%" height="100%"/>
					<div id="chart1"></div>
              </div>
            </div> -->
