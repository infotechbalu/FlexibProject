...
public class ShoppingCart1 {
	...
	public static String ProductID = "PDCT16";
	...
	public void ShoppingCart() throws MalformedURLException, InterruptedException {
		extent = new ExtentReports(System.getProperty("user.dir") + "/ShoppingCartDemo.html", true);
		...
		f = new File("D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart_testdata\\Shopping Cart.xls");
	...
	public void CreateProduct()
			throws InterruptedException, IOException, RowsExceededException, WriteException, AWTException {
		...
		for (int i = 1; i < nor2; i++) {
				...
				test.log(LogStatus.PASS,
						"Entered username, password and clicked login button. User navigated to Product listing page."
								+ test.addScreenCapture(new File(
										"D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart\\screenshots\\"
												+ fileName).getPath()));
			...
			Thread.sleep(2000);
			// File Upload
			StringSelection stringSelection = new StringSelection("download.jpg");
			...
			if (driver.getPageSource().contains(ProductID)) {
				...
				test.log(LogStatus.FAIL, "Product not created successfully." + test.addScreenCapture(new File(
						"D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart\\screenshots\\" + fileName1)
								.getPath()));
			...
			if (driver.getPageSource().contains(ProductID)) {
				...
				test.log(LogStatus.PASS,
						"Created product is displayed on Product List page." + test.addScreenCapture(
								new File("D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart\\screenshots\\"
										+ fileName1).getPath()));
	...
	@Test
	public void BuyProduct() throws InterruptedException, IOException, RowsExceededException, WriteException {
		test = extent.startTest(Thread.currentThread().getStackTrace()[1].getMethodName(),
				"Online Shopping - Create product and Buy Product.");
		test.log(LogStatus.INFO, "Buy a product");
		// Buy a Product
		Thread.sleep(1000);
		driver.findElement(By.xpath("//a[@href='/SpringMVCAnnotationShoppingCart/buyProduct?code=PDCT16']")).click();
		...
		if (driver.findElement(By.xpath("//*[contains(text(),'Continue')]")).isDisplayed()) {
			...
			test.log(LogStatus.PASS, "Clicked 'Buy a Product' link, user navigated to buy a product page"
					+ test.addScreenCapture(new File(
							"D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart\\screenshots\\" + fileName2)
									.getPath()));
		...
		if (driver.getPageSource().contains(ProductID)) {
			...
			test.log(LogStatus.PASS, "Added quantity and clicked 'Continue Buy' link, product placed in 'My Cart' page"
					+ test.addScreenCapture(new File(
							"D:\\Balu\\Workspace\\ShoppingCart_Demo\\src\\com\\shoppingcart\\screenshots\\" + fileName3)
									.getPath()));
