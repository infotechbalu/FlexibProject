...
public void CallBatch()
{
	...
	String path = "D:\\Kondal Thummeti\\Eclipse Workspace\\Flexib_Automation\\WebContent\\Flexib_ShoppingCart\\ShoppingCartDemo.bat";
...
String a= request.getParameter("sample");
if(a == null)
	CallBatch();
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Keyword Automation Execution</title>
