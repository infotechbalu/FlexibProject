...
<html lang="en">
  <head>
    ...
    <title>Keyword Driven Framework Execution</title>
        ...
        <div class="right_col main" role="main">
         ...
         <div class="row tile_count" style="margin-bottom: 0px; margin-top: 0px;">
          <div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <br/><br/>
              <div class="count red"><div class="test"><h1><font color="#079DF9">Keyword Driven Framework</font></h1></div></div>
                ...
                <div class="x_content">
                  <div class="widget_summary">
                   ...
                   <table width="100%">
                   		<tr>
                   			<td width="40%">
                   				<form method="GET" action="Execution.jsp">
								  ...
								  <a href="file:///E:/PerformanceTestingSoft/apache-jmeter-5.1.1/apache-jmeter-5.1.1/sampleProject/HTML/index.html">Report</a>
								</form>
                   			</td>                    			
                   			<td width="60%">                   				
                   							<%
												...
												<table height="300px">
			                   					...
			                   					<tr height="70">
			                   						<td bgcolor="#050505" style="height:85px;">
			                   							...
			                   							<font color="white">
                   							<%
												String path="E:/PerformanceTestingSoft/apache-jmeter-5.1.1/apache-jmeter-5.1.1/bin/";
												String resultFolder="E:/PerformanceTestingSoft/apache-jmeter-5.1.1/apache-jmeter-5.1.1/sampleProject/RESULT";
												String htmlFolder="E:/PerformanceTestingSoft/apache-jmeter-5.1.1/apache-jmeter-5.1.1/sampleProject/HTML";
												String scriptpath="E:\\PerformanceTestingSoft\\apache-jmeter-5.1.1\\apache-jmeter-5.1.1\\sampleProject\\OnlineShoppingCartFWK.jmx";
												String scriptResult="E:\\PerformanceTestingSoft\\apache-jmeter-5.1.1\\apache-jmeter-5.1.1\\sampleProject\\RESULT\\result.jtl";
												String scriptHTML="E:\\PerformanceTestingSoft\\apache-jmeter-5.1.1\\apache-jmeter-5.1.1\\sampleProject\\HTML";
