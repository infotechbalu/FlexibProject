...
@media screen and (max-height: 450px) {
  ...
  <body class="nav-md">
                ...
                <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i><small>Dashboard</small><span class="fa fa-chevron-down"></span></a>
				  ...
				  <li><a><i class="fa fa-calculator"></i>Calculators<span class="fa fa-chevron-down"></span></a>
					    <ul class="nav child_menu">
						  <li><a href="TphCalculation.jsp">Load Generator</a></li>
        ...
        <div class="right_col main" role="main">
          ...
          <div class="row tile_count">
			<div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <span class="count_top"><div class="card-body-icon"><h1>TPH/TPS Calculator</h1></div></span>
			  <br/>
                ...
                <div class="col-md-12 col-sm-1 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title" id="navigate">
                      <h4><font color="#C080F9"><b>TPH/TPS Calculator</b></font></h4>
                     <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                   ...
                   <table width="50%">
                   		<tr> 
                   			<td width="25%">
                   				...
                   				<form id="calTph" method="GET" action="TphCalculation.jsp">
							  No. of Users (Threads)*<br>
							  <input id="NoOfThreads" type="text" class="input">
							  <br><br>
							  Time to complete one iteration(Sec)<br>
							  <input id="ETERTime" type="text" class="input">
							  <br><br>
							  No. of Transactions in one Iteration*<Br>
							  <input id="NoofTransITr" type="text" class="input">
							  <br><br>
							  Pacing (in seconds) #Use zero for no pacing*<Br>
							  <input id="TPacing" type="text" class="input">
							  <br><br>
							  Total Think Time (in seconds) #Use zero for no think time*<Br>
							  <input id="TotalTT" type="text" class="input">
							  <br><br>
							  Calculation Result<Br>
							  <br>
							  Estimated TPS (Transactions per second) <Br>
							  <input id="ETPSResult" type="text" readonly="readonly" disabled>
							  <br><br>
							  Estimated TPH (Transactions per hour)<Br>
							  <input id="ETPHResult" type="text" readonly="readonly" disabled>
							  <br><br>
							  <input type="button" name="button" value="Calculate" onclick="tpscalcuations()">
							  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <!--</div>-->
<script>
function tpscalcuations()
{
        nothreads = Number(document.getElementById("NoOfThreads").value);
        etetime = Number(document.getElementById("ETERTime").value);
		notransitr = Number(document.getElementById("NoofTransITr").value);
        tpacing = Number(document.getElementById("TPacing").value);
		totalt = Number(document.getElementById("TotalTT").value);
		if (nothreads == "" || etetime== "" || notransitr== "" || tpacing== "" || totalt== "" )
		{
		alert("All the fields with * sign are compulsory");
		return false;
		}
		tpsvalue=(nothreads*notransitr)/(etetime+totalt+tpacing);
		tphvalue=tpsvalue*3600;
        document.getElementById("ETPSResult").value=tpsvalue.toFixed(2);
		document.getElementById("ETPHResult").value=tphvalue.toFixed(2);
}
</script>
<script>
function resetform1() {
  document.getElementById("calTph").reset();
}
</script>
