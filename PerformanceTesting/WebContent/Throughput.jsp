        ...
        <div class="right_col main" role="main">
          ...
          <div class="row tile_count">
			<div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <span class="count_top"><div class="card-body-icon"><h1>Throughput</h1></div></span>
			  <br/>
          ...
          <div class="row">
                ...
                <div class="col-md-12 col-sm-1 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">                       
							<form method="GET" action="Throughput.jsp">
							...
							if (request.getParameter("submit")!= null) {
								String NumberOfRequests1=request.getParameter("NumberOfRequests");
								String TotalTime1=request.getParameter("TotalTime");
								//System.out.println("test"+NumberOfRequests1);
								if(request.getParameter("NumberOfRequests")!="" && request.getParameter("TotalTime")!=""){
									int NumberOfRequests=Integer.parseInt(NumberOfRequests1);
									int TotalTime=Integer.parseInt(TotalTime1);								
									double Throughput=0;	
									if(TotalTime!=0 && NumberOfRequests!=0){
										Throughput=(((double)NumberOfRequests)/(TotalTime));
										 DecimalFormat df = new DecimalFormat("#.##");
										// System.out.println(Throughput);
									%>
									<h3>Throughput:&nbsp;&nbsp;<font color="Red"><b><%=df.format(Throughput)%></b></font></h3>		
									<%
										///formatter.close();
									}
									else{
									%>
										<h3><font color="Red">Invalid Input</font></h3>
									<%
									}
								}
							}
...
function myFunction() {
    ...
    x = document.getElementById("TotalTime").value;
