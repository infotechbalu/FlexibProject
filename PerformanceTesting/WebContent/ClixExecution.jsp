        ...
        <div class="right_col main" role="main">
         ...
         <div class="row tile_count" style="margin-bottom: 0px; margin-top: 0px;">
          <div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <br/><br/>
              <div class="count red"><div class="test"><h1><font color="#079DF9">Performance Testing</font></h1></div></div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile">
                <div class="x_title">
                  <h4><font color="#C080F9"><b>Clix_Capital Performance Test Execution</b></font></h4>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="widget_summary">
                   ...
                   <table width="100%">
                   		<tr>
                   			<td width="40%">
                   				<form method="GET" action="ClixExecution.jsp">
                   			...
                   			<td width="60%">                   				
											...
											if (request.getParameter("submit") != null) {
                   							...
                   							<%
												...
												String scriptpath="F:\\Projects\\Clix_Capital\\CLIX.jmx";
