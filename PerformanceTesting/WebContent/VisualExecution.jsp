      ...
      <div class="main_container">
        ...
        <div class="right_col main" role="main">
         ...
         <div class="row tile_count" style="margin-bottom: 0px; margin-top: 0px;">
          <div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <br/><br/>
              <div class="count red"><div class="test"><h1><font color="#079DF9">Visual Automation</font></h1></div></div>
				...
				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count mytable" style="padding-left: 0px; padding-bottom: 0px; padding-right: 0px; width: 600px; margin-bottom: 0px;">
					<div class="myrow">
						<div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/automationtest.jpg" ></div>							
						</div>
					  <div class="tile_stats_count mycell">
						 <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/checkmycolours.jpg" ></div>							
						</div>
						<div class="tile_stats_count mycell">
							  <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/clickingcoding.png" ></div>							
						</div>
						<div class="tile_stats_count mycell">
						  <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/difference.png" ></div>							
						</div>
						</div>
						<div class="tile_stats_count mycell">
						  <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/responsive.png" ></div>							
						</div>
						</div>
					</div>
				</div>
                ...
                <div class="x_content">
                  <div class="widget_summary">
                   ...
                   <table width="100%">
                   		<tr>
                   			<td width="40%">
                   				<form method="GET" action="VisualExecution.jsp">
								  Reference URL:  &nbsp; &nbsp; &nbsp;&nbsp;<input type="text" name="SERVERURL">
								  <br>
								  <input type="submit" name="CreateReference" id="CreateReference" onclick="window.open('http://localhost:8080/PerformanceTesting/blank.jsp')" value="CreateReference">
					
	
								  <a href="file:///D:/Tools/apache-jmeter-3.1/apache-jmeter-3.1/sampleProject/HTML/index.html"></a>
								</form>
                   			</td>                    			
                   			<td width="60%">                   				
                   							<%
											if (request.getParameter("CreateReference") != null) {
												%>
												
                   							<%
												//String path="D:/VisualRegressionTesting/Projects/Flexib";
                   		...
                   		<tr>
                   			<td width="40%">
                   				<form method="GET" action="VisualExecution.jsp">
								  Test URL:  &nbsp; &nbsp; &nbsp;&nbsp;<input type="text" name="SERVERURL">
								  <br>
								  <input type="submit" name="TestReference" id="TestReference" onclick="window.open('http://localhost:8080/PerformanceTesting/blank2.jsp')" value="TestReference">
                   			...
                   			<td width="60%">                   				
                   							<%
											if (request.getParameter("TestReference") != null) {
												%>
        ...
        <footer>
          <div class="pull-right">
           Visual Automation Testing Dashboard
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
