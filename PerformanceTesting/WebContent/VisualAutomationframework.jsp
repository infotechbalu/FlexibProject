...
<html lang="en">
  <head>
    ...
    <title>Visual Automation Framework</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col main" role="main">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <br/><br/>
              <div class="count red"><div class="test"><h1><font color="#079DF9">Visual Automation Framework</font></h1></div></div>
				...
				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count mytable" style="padding-left: 0px; padding-bottom: 0px; padding-right: 0px; width: 600px; margin-bottom: 0px;">
					<div class="myrow">
					  ...
					  <div class="tile_stats_count mycell">
						...
						<div class="tile_stats_count mycell">
						  <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/visualAuto.jpeg" ></div>							
						</div>
						</div>
						<div class="tile_stats_count mycell">
						  <div class="tile_stats_count mycell">
						  <div class="count blue"><img style="width:200px;height:100px;mix-blend-mode: multiply;" src="images/jsvalidator.jpg" ></div>							
						</div>
						</div>
					</div>
				</div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile">
                <div class="x_title">
                  <h4><font color="#C080F9"><b>Identify Visual Difference</b></font></h4>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="widget_summary">
                    <img src="images/Difference1.PNG" width="100%" height="100%"/>
                    <div class="clearfix"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel tile fixed_height_220 overflow_hidden">
                <div class="x_title" id="navigate">
                  <h4><font color="#C080F9"><b>Mobile</b></font></h4>
                  <div class="clearfix"></div>
                </div>
					<img src="images/Difference2.png" width="100%" height="435px"/>
					<!--<div id="chart1"></div>-->
              </div>
            </div>
			...
			<div class="col-md-8 col-sm-8 col-xs-12">
              <div class="x_panel tile fixed_height_220 overflow_hidden">
                <div class="x_title" id="navigate">
                  <h4><font color="#C080F9"><b>Responsive</b></font></h4>
                  <div class="clearfix"></div>
                </div>
					<img src="images/Responsivedesign.PNG" width="100%" height="100%"/>
					<!--<div id="chart1"></div>-->
              </div>
            </div>
