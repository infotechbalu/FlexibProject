                ...
                <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i><small>Dashboard</small><span class="fa fa-chevron-down"></span></a>
				  ...
				  <li><a><i class="fa fa-calculator"></i>Calculators<span class="fa fa-chevron-down"></span></a>
					    <ul class="nav child_menu">
						  <li><a href="VusersCalculator.jsp">Load Generator</a></li>
        ...
        <div class="right_col main" role="main">
          ...
          <div class="row tile_count">
			<div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <span class="count_top"><div class="card-body-icon"><h1>Virtual Users Calculator</h1></div></span>
			  <br/>
                ...
                <div class="col-md-12 col-sm-1 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title" id="navigate">
                      <h4><font color="#C080F9"><b>VUsers Calculator</b></font></h4>
                     <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                   ...
                   <table width="50%">
                   		<tr> 
                   			<td width="25%">
                   				...
                   				<form id="calvusersf" method="GET" action="VusersCalculator.jsp">
							  Time to complete one iteration* (in seconds)<br>
							  <input id="oneItrTime" type="text" class="input">
							  <br><br>
							  Expected No. of Iterations per hour*<br>
							  <input id="Expetitr" type="text" class="input">
							  <br><br>
							  ...
							  <input id="Ttt" type="text" class="input">
							  <br><br>
							  Calculation Result<Br>
							  <br>
							  Calculated No. of Users (Threads)<Br>
							  <input id="NoofVusers" type="text" readonly="readonly" disabled>
							  <br><br>
							  <input type="button" name="button" value="Calculate" onclick="vuserscal()">
							  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
function vuserscal()
{
        num1 = Number(document.getElementById("oneItrTime").value);
        num2 = Number(document.getElementById("Expetitr").value);
		num3 = Number(document.getElementById("Tpacing").value);
        num4 = Number(document.getElementById("Ttt").value);
        if (num1 == "" || num2== "" || num3== "" || num4== "")
		{
		alert("All the fields with * sign are Mandatory");
		return false;
		}
		throughput=num2/3600;
		novusers=throughput*(num3+num1+num4);
        document.getElementById("NoofVusers").value=novusers;
}
</script>
<script>
function resetform1() {
  document.getElementById("calvusersf").reset();
}
</script>
