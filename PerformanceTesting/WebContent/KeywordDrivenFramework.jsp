...
<html lang="en">
  <head>
    ...
    <title>Keyword Driven Framework</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
             <!--   <a href="index.jsp" class="site_title"><img style="width:210px;height:50px" src=""/></a>-->
			</div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile">
                <div class="x_title">
                  <h4><font color="#C080F9"><b>Scenarios</b></font></h4>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="widget_summary">
                    <img src="images/Scenarios.png" width="100%" height="100%"/>
                    <div class="clearfix"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel tile fixed_height_220 overflow_hidden">
                <div class="x_title" id="navigate">
                  <h4><font color="#C080F9"><b>Keywords in TestPlan</b></font></h4>
                  <div class="clearfix"></div>
                </div>
					<img src="images/KeywordsinTestPlan.jpg" width="100%" height="435px"/>
					<!--<div id="chart1"></div>-->
              </div>
            </div>
