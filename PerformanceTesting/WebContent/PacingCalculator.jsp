                ...
                <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i><small>Dashboard</small><span class="fa fa-chevron-down"></span></a>
				  ...
				  <li><a><i class="fa fa-calculator"></i>Calculators<span class="fa fa-chevron-down"></span></a>
					    <ul class="nav child_menu">
						  <li><a href="PacingCalculator.jsp">Load Generator</a></li>
        ...
        <div class="right_col main" role="main">
          ...
          <div class="row tile_count">
			<div class="col-md-6 col-sm-6 col-xs-6 tile_stats_count">
              <span class="count_top"><div class="card-body-icon"><h1>Pacing Calculator</h1></div></span>
			  <br/>
                ...
                <div class="col-md-12 col-sm-1 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title" id="navigate">
                      <h4><font color="#C080F9"><b>Pacing Calculator</b></font></h4>
                     <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                   ...
                   <table width="50%">
                   		<tr> 
                   			<td width="25%">
                   				...
                   				<form id="calpacingform" method="GET" action="PacingCalculator.jsp">
							  No Of Users*<br>
							  <input id="NoofUsers" type="text" class="input">
							  <br><br>
							  Transaction Per Hour(TPH)*<br>
							  <input id="Tph" type="text" class="input">
							  <br><br>
							  Script Execution Time(Sec)*<Br>
							  <input id="Scrtptexctime" type="text" class="input">
							  <br><br>
							  Total Think Time in Script(Sec)*<Br>
							  <input id="TotThinktime" type="text" class="input">
							  <br> <br>
							  Pacing Calculation Result<Br>
							  <br>
							  Pacing<Br>
							  <input id="pacingcal" type="text" readonly="readonly" disabled>
							  <br><br>
							  <input type="button" name="button" value="Calculate" onclick="calPacing()">
							  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  <input type="button" name="button" value="Reset" onclick="resetform2()">
							</form>
							</td>                    			                 		
                   		</tr>
                   </table>                 		
...
function calPacing() 
{
  var noofuser=document.getElementById("NoofUsers").value;
  var transaction=document.getElementById("Tph").value;
  var scriptexetime=document.getElementById("Scrtptexctime").value;
  var thinktime=document.getElementById("TotThinktime").value;

if (noofuser== "" || transaction== "" || scriptexetime== "" || thinktime==""  )
{
alert("All the fields with * sign are compulsory");
document.getElementById("pacingcal").value="";
return false;
}

var pacing=((noofuser/(transaction/3600))-scriptexetime-thinktime)

if (isNaN(pacing)==true)
{
...
document.getElementById("pacingcal").value=parseFloat((pacing).toFixed(3)); 
}
</script>
<script>
function resetform2() {
  document.getElementById("calpacingform").reset();
}
</script>
